...
2. Create a new application in your Enode developer dashboard
3. Get your Client ID and Client Secret from the Enode dashboard
4. Install the XPENG Car Manager app on your Homey
5. Add your vehicle:
